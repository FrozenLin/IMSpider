...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        browser = webdriver.Chrome(executable_path="E:/Software/chromedriver_win32/chromedriver.exe")
        ...
        for cookie in Cookies:
            # 写入文件
            f = open('E:/PythonProgram/ArticleSpider/ArticleSpider/cookies/zhihu' + cookie['name'] + '.zhihu', 'wb')
